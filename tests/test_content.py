...
class MtgjsonContentTest(unittest.TestCase):
    ...
    def test_populateShouldAddAvailableInformationToSets(self):
        ...
        self.assertListEqual(sets, mtgjson_data.data_sets([d_ids.SET_DATA.RELEASE_DATE]),
        ...
        sets = self.content.available_sets()
        self.content.populate(sets, data_ids)
        self.assertListEqual(sets, mtgjson_data.data_sets([d_ids.SET_DATA.BORDER]),
        ...
        sets = self.content.available_sets()
        self.content.populate(sets, data_ids)
        self.assertListEqual(sets, mtgjson_data.data_sets([d_ids.SET_DATA.BLOCK]),
        ...
        sets = self.content.available_sets()
        self.content.populate(sets, data_ids)
        self.assertListEqual(sets, mtgjson_data.data_sets([d_ids.SET_DATA.TYPE]),
        ...
        sets = self.content.available_sets()
        self.content.populate(sets, data_ids)
        self.assertListEqual(sets, mtgjson_data.data_sets([d_ids.SET_DATA.BOOSTER]),
        ...
        sets = self.content.available_sets()
        self.content.populate(sets, data_ids)
        self.assertListEqual(sets, mtgjson_data.data_sets(data_ids),
                             "case 6: populating set list with multiple fields not successful")
    ...
    def test_populatingWhenTheRequestedDataIsAlreadyAvailableDoesNothing(self):
        ...
        sets = mtgjson_data.data_sets(data_ids) #already contains 'release date'
        self.content.populate(sets, data_ids)
        self.assertListEqual(sets, mtgjson_data.data_sets(data_ids),
